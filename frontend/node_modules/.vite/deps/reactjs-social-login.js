...
var u = (0, import_react.memo)(function(t2) {
  ...
  var M = (0, import_react.useCallback)(function(e2, t3) {
  ...
  }, []), q = (0, import_react.useCallback)(function() {
    ...
    e2.authResponse ? O ? j({ provider: "facebook", data: c({}, e2.authResponse) }) : $(e2.authResponse) : L(e2), K(false);
  }, [$, O, L, j]), V = (0, import_react.useCallback)(function() {
    q() ? F(true) : M(document, function() {
      J({ appId: a2, xfbml: m2, version: w2, state: p2, cookie: f2, redirect_uri: E, response_type: N }, document);
    });
  }, [p2, a2, m2, f2, w2, J, E, N, M, q]), W = (0, import_react.useCallback)(function() {
    U && !H && (l.FB ? (K(true), P && P(), l.FB.login(Q, { scope: d2, return_scopes: C, auth_type: b2 })) : (V(), L("Fb isn't loaded!"), K(false)));
  }, [V, d2, L, b2, U, P, H, C, Q]);
  ...
  var Q = (0, import_react.useCallback)(function() {
    ...
    if ("accessToken" === v2) {
      ...
      fetch("https://www.googleapis.com/oauth2/v3/tokeninfo?id_token=" + e2.credential, { method: "GET" }).then(function(e3) {
        ...
        console.log("🚀 ~ file: index.tsx ~ line 153 ~ response", t4);
        var o2 = c({}, e2, t4);
        L({ provider: "google", data: o2 });
      }).catch(function(e3) {
        P(e3);
    ...
    N ? L({ provider: "google", data: e2 }) : W(e2);
  }, [N, W, L]), Y = (0, import_react.useCallback)(function() {
    Q() ? M(true) : V(document, "script", "google-login", "https://accounts.google.com/gsi/client", function() {
      var e2 = { client_id: a2, ux_mode: f2 }, t3 = null;
      "idToken" === v2 ? h.google.accounts.id.initialize(c({}, e2, { auto_select: T, callback: X })) : t3 = h.google.accounts.oauth2.initTokenClient(c({}, e2, { scope: d2, prompt: u2, login_hint: y2, access_type: b2, hosted_domain: O, redirect_uri: E, cookie_policy: C, discoveryDocs: B, immediate: true, fetch_basic_profile: F, callback: X })), t3 && $(t3), M(true);
    });
  }, [d2, u2, f2, a2, y2, T, b2, E, v2, B, C, O, X, F, V, Q]), Z = (0, import_react.useCallback)(function() {
    K && (h.google ? (S2 && S2(), J ? J.requestAccessToken() : h.google.accounts.id.prompt()) : (Y(), P("Google SDK isn't loaded!")));
  }, [J, K, Y, S2, P]);
  return import_react.default.createElement("div", { className: w2, onClick: Z }, A);
});
var v = (0, import_react.memo)(function(t2) {
  ...
  var j = (0, import_react.useCallback)(function(e2) {
    ...
    e2 && (I({ provider: "github", type: "code", code: e2 }), localStorage.removeItem("instagram"));
...
var _ = (0, import_react.memo)(function(t2) {
  var o2 = t2.state, n2 = void 0 === o2 ? "" : o2, a2 = t2.scope, s2 = void 0 === a2 ? "" : a2, d2 = t2.client_id, l2 = t2.client_secret, u2 = t2.className, h2 = void 0 === u2 ? "" : u2, m2 = t2.redirect_uri, v2 = t2.isOnlyGetCode, f2 = void 0 !== v2 && v2, g2 = t2.isOnlyGetToken, w2 = void 0 !== g2 && g2, _2 = t2.children, y2 = t2.onLoginStart, k2 = t2.onReject, b2 = t2.onResolve;
  (0, import_react.useEffect)(function() {
    var e2 = new URL(window.location.href), t3 = e2.searchParams.get("code"), o3 = e2.searchParams.get("state");
  ...
  var S2 = (0, import_react.useCallback)(function(e2) {
    ...
    var e2 = window.screen.width / 2 - 225, t3 = window.screen.height / 2 - 365;
    window.open("https://www.pinterest.com/oauth/?client_id=" + d2 + "&scope=" + s2 + "&state=" + n2 + "_pinterest&redirect_uri=" + m2 + "&response_type=code&scope=boards:read,pins:read,user_accounts:read", "Pinterest", "menubar=no,location=no,resizable=no,scrollbars=no,status=no, width=450, height=730, top=" + t3 + ", left=" + e2);
  }, [s2, n2, d2, m2, y2, j]);
